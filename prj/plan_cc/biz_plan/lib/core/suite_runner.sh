...
# SAMPLES_DIR, PROMPTS_DIR, RUNTIME_DIR은 settings.sh에서 export됨
RUNS_DIR="${RUNTIME_DIR}/runs/${DATE}"
...
retry_writer() {
    ...
    local full_path="${SAMPLES_DIR}/${sample_file}"
...
run_suite() {
    local suite_file="${SAMPLES_DIR}/${SUITE}.yaml"
