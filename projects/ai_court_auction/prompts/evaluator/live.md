# Evaluator Prompt - Live (v1)
# Source: _meta/evaluator_v1.yaml
# Purpose: 운영용 평가자 (일반 워크플로우에서 사용)
...
Core로 분류 안 되는 새 유형 발견 시 proposed_tags에 제안 (Core 중 하나에 임시 매핑 필수)
