...
export CHATGPT_TAB="${CHATGPT_TAB:-2}"
export CHATGPT_PROJECT_URL="${CHATGPT_PROJECT_URL:-https://chatgpt.com/g/g-p-698a705a2d348191a5c43fc28fe1c8c5-plan1/}"
export PLAN_PROJECT_URL="${CHATGPT_PROJECT_URL}"
